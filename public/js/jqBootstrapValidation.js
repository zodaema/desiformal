        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("pattern") !== undefined) {
              message = "กรอกหมายเลขโทรศัพท์ 10 หลัก<!-- data-validation-pattern-message to override -->";
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "รูปแบบของอีเมล์ยังไม่ถูกต้อง<!-- data-validation-email-message to override -->";
            ...
            //                                                   CAPTCHA
            // ---------------------------------------------------------
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "captcha") {
                message = "กรอกรหัสยืนยันตัวไม่ถูกต้อง";
            }
            // ---------------------------------------------------------
            //                                                MINCHECKED
            // ---------------------------------------------------------
            ...
            function (e, params) {
              ...
              if (errorsFound.length) {
                ...
                if (settings.options.semanticallyStrict && errorsFound.length === 1) {
                  ...
                  $helpBlock.html("<ul role=\"alert\" class=\"textalert\"><li>" + errorsFound.join("</li><li>") + "</li></ul>" +
                    ( settings.options.prependExistingHelpBlock ? $helpBlock.data("original-contents") : "" ));
                }
              } else {
